/*! Enhanced by Botem Bao
 * Author: Botem Bao
 * Select/Dselect/Anti Select
*/
...
TableTools.BUTTONS = {
    ...
    "sall": $.extend( {}, TableTools.buttonBase, {
        //"sAction": "flash_save",
        "sButtonClass": "DTTT_button_sall",
        "sButtonText": "不选",
        "sFieldBoundary": '"',
        "sFieldSeperator": ",",
        "fnClick": function( nButton, oConfig ) {
            if (nButton.text == "全选") {
                for (var i in this.s.dt.aoData) {
                    var tr = this.s.dt.aoData[i].nTr;
    ...
    "asel": $.extend( {}, TableTools.buttonBase, {
        //"sAction": "flash_save",
        "sButtonClass": "DTTT_button_asel",
        "sButtonText": "反选",
        "sFieldBoundary": '"',
        "sFieldSeperator": ",",
    ...
    "exp": $.extend( {}, TableTools.buttonBase, {
        "sButtonClass": "DTTT_button_exp",
        "sButtonText": "导出",
        "sFieldBoundary": '"',
        "sFieldSeperator": ",",
        "fnClick": null
