...
$.fn.dataTableExt.oApi.fnColReorder = function ( oSettings, iFrom, iTo )
{
	...
	if ( oSettings.aoColumns[iFrom].bVisible )
	{
		 ...
		 */
	    var iVisibleIndex = oSettings.oApi._fnColumnIndexToVisible(oSettings, iFrom);
		var iInsertBeforeIndex = null;

		i = iTo < iFrom ? iTo : iTo + 1;
		while ( iInsertBeforeIndex === null && i < iCols )
		{
		    iInsertBeforeIndex = oSettings.oApi._fnColumnIndexToVisible(oSettings, i);
			i++;
		}
	...
	for ( i=0, iLen=iCols ; i<iLen ; i++ )
	{
		...
		oSettings.oApi._fnSortAttachListener(oSettings, oSettings.aoColumns[i].nTh, i);
	}
