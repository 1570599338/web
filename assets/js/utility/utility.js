...
(function($, window, document, undefined) {
   ...
   $.fn.adminpanel = function(options) {
      ...
      plugin.find('.panel').on('click', '.panel-controls > a', function (e) {
         e.preventDefault();
      ...
      var methods = {
         init: function(options) {
            ...
            plugin.find(pluginGrid).each(function (i, e) {
               $(e).attr('id', 'grid-' + i);
            });
         ...
         createControls: function(options) {
            ...
            panels.each(function(i, e) {
               ...
               var title = This.attr('data-panel-title'); title = title === undefined ? false : (title == 'true' ? true : false);
               var color = This.attr('data-panel-color'); color = color === undefined ? false : (color == 'true' ? true : false);
               var collapse = This.attr('data-panel-collapse'); collapse = collapse === undefined ? false : (collapse == 'true' ? true : false);
               var fullscreen = This.attr('data-panel-fullscreen'); fullscreen = fullscreen === undefined ? false : (fullscreen == 'true' ? true : false);
               var remove = This.attr('data-panel-remove'); remove = remove === undefined ? false : (remove == 'true' ? true : false);
               //var callback = This.attr('data-panel-callback'); callback = callback === undefined ? false : (callback == 'true' ? true : false);
               //var paneldock = This.attr('data-panel-dockable'); paneldock = paneldock === undefined ? false : (paneldock == 'true' ? true : false);
               //var expose = This.attr('data-panel-expose'); expose = expose === undefined ? false : (expose == 'true' ? true : false);
               var loader = This.attr('data-panel-loader'); loader = loader === undefined ? true : (loader == 'true' ? true : false);
         ...
         controlHandlers: function(e) {
            ...
            var panel = This.parents(defaults.grid + ' .panel');
