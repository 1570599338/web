		  ...
		  JsBubble.prototype ={
			     ...
			     show:function(Obj){
					 ...
					 this.Tinfo = {
						 ...
						 BoColor:Obj.BoColor || "#fff",   //边框颜色
						 BaColor:Obj.BaColor || "#fff",  //箭头背景颜色
						 CBaColor:Obj.CBaColor || "#fff",  //内容背景颜色
						 TBaColor:Obj.TBaColor || "#fff", //标题背景颜色
						 TBoColor:Obj.TBoColor || "#ECECEC", //标题背景颜色
				 ...
				 addCon:function(Tinfo){
					 ...
					 if(Tinfo.Close){
					     $Close = $('<a href="javascript:;" class="jsTip-close jsbox-close"></a>');
						 Cpar = 0;
